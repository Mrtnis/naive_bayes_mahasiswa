<div class="card sidebar shadow">
  <div class="card-body py-4">
    ...
    <div class="row">
      <a href="<?= $base_url ?>/admin/data_latih.php" class="col list-data" id="data_latih"><i class="bi bi-journals me-3" ></i> Data Latih</a>
    </div>
    <div class="row">
      <a href="#" class="col list-data" id="data_uji"><i class="bi bi-journals me-3"></i> Data Uji</a>
    </div>
    <div class="row">
